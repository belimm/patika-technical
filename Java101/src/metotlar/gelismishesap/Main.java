package metotlar.gelismishesap;
...
public class Main {
    ...
    static void mod() {
        ...
        if (n2 == 0) {
            System.out.println("Mod için 2. sayı 0 olamaz!");
        } else {
            System.out.println("Sonuç : " + n1 % n2);
        }
    }

    // ✅ YENİ - Dikdörtgen Alan ve Çevre
    static void rectangle() {
        ...
        if (uzunKenar <= 0 || kisaKenar <= 0) {
            System.out.println("Kenar değerleri pozitif olmalıdır!");
        } else {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (select) {
                ...
                case 0: System.out.println("Çıkış yapıldı. Güle güle!"); break;
